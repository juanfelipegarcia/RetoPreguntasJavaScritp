window.onload = function() {
    base_preguntas = readText("../questionsGame3.json")
  ...
  function escogerPreguntaAleatoria() {
    ...
    if (preguntas_hechas > 5) {
      ...
      let valueCategoria3 = puntos;
      sessionStorage.setItem("puntosC3SS", valueCategoria3)

      alert(`Termina la 3ª categoria. Puntos en 3ª categoria ${puntos},  aceptar para avanzar`);
      window.location.href= "categoria4.html";
