window.onload = function() {
    base_preguntas = readText("../questionsGame2.json")
  ...
  function escogerPreguntaAleatoria() {
    ...
    if (preguntas_hechas > 5) {
      ...
      let valueCategoria2 = puntos;
      sessionStorage.setItem("puntosC2SS", valueCategoria2)

      alert(`Termina la 2ª categoria. Puntos en 2ª categoria ${puntos},  aceptar para avanzar`);
      window.location.href= "categoria3.html";
