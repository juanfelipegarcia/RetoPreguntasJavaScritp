window.onload = function() {
    base_preguntas = readText("../questionsGame5.json")
  ...
  function escogerPreguntaAleatoria() {
    ...
    if (preguntas_hechas > 5) {
      ...
      let valueCategoria5 = puntos;
      sessionStorage.setItem("puntosC5SS", valueCategoria5)

      alert(`Termina la 5ª categoria. Puntos en 5ª categoria ${puntos},  aceptar para avanzar`);
